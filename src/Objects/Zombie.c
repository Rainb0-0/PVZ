...
// WALKING
const int ZOMBIE_WALKING_FRAME_WIDTH = 197;
const int ZOMBIE_WALKING_FRAME_HEIGHT = 148;
const int ZOMBIE_WALKING_MAX_FRAMES = 45;
const float ZOMBIE_WALKING_FRAME_TIME = FRAME_TIME;
// EATING
const int ZOMBIE_EATING_FRAME_WIDTH = 197;
const int ZOMBIE_EATING_FRAME_HEIGHT = 148;
const int ZOMBIE_EATING_MAX_FRAMES = 40;
const float ZOMBIE_EATING_FRAME_TIME = FRAME_TIME;
// DYING
const int ZOMBIE_DYING_FRAME_WIDTH = 197;
const int ZOMBIE_DYING_FRAME_HEIGHT = 148;
const int ZOMBIE_DYING_MAX_FRAMES = 27;
const float ZOMBIE_DYING_FRAME_TIME = FRAME_TIME;
