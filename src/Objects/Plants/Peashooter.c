...
const int PEASHOOTER_IDLE_MAX_FRAMES = 24;
const float PEASHOOTER_IDLE_FRAME_TIME = FRAME_TIME;
// SHOOTING
const int PEASHOOTER_SHOOTING_FRAME_WIDTH = 80;
const int PEASHOOTER_SHOOTING_FRAME_HEIGHT = 80;
const int PEASHOOTER_SHOOTING_MAX_FRAMES = 25;
const float PEASHOOTER_SHOOTING_FRAME_TIME = FRAME_TIME;
